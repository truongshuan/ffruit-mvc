                    ...
                    <div class="col-lg-8">
                        <div class="single-article-section">
                                <div class="single-article-text">
                                    <div class="single-artcile-bg" style="background-image: url(<?= ROOT_URL . $data['post'][0]['thumbnail']?>)">
                                    </div>
                                    <p class="blog-meta">
                                        <span class="author"><i class="fas fa-user"></i><?= ($data['author']['id'] == $data['post'][0]['id_author']) ? $data['author']['fullname']  : 'Admin' ?></span>
                                        <span class="date"><i class="fas fa-calendar"></i><?php echo date('d-m-Y', strtotime($data['post'][0]['created_at'])) ?></span>
                                    </p>
                    ...
                    <div class="col-lg-4">
                        <div class="sidebar-section">
                            <div class="recent-posts">
                                ...
                                <ul>
                                    <?php
                                    foreach($data['postSame'] as $relate) :
                                    ?>
                                    <li><a href="<?= ROOT_URL . 'ClientPostController/detail/'. @$relate['relate_id'] ?>"><?= $relate['title'] ?></a></li>
                                    <?php
                                        endforeach;
                                    ?>
                                </ul>
                    ...
                    <div class="row">
                        <div class="col-lg-8 offset-lg-2 text-center">
                            <div class="error-text">
                                ...
                                <p>Không tìm thấy bài viết mà bạn yêu cầu.</p>
