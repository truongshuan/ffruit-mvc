            ...
            <div class="col-xxl-4 col-xl-5 col-lg-5 col-md-7 col-sm-9">
                ...
                <div class="card shadow-lg">
                    <div class="card-body p-5">
                        <h1 class="fs-4 card-title fw-bold mb-4 text-center">Quên mật khẩu - SMS</h1>
                        <?php if (isset($_SESSION['error']['error_forgot'])) :  ?>
                            <div class="alert alert-danger text-center">
                                <?= Session::getError('error_forgot') ?>
                            </div>
                        <?php endif; ?>
                        <form action="<?= ROOT_URL ?>ForgotController/actionSMS" method="POST" class="needs-validation">
                            <div class="mb-3">
                                <label class="mb-2 text-muted" for="phone">Phone</label>
                                <input id="phone" type="number" class="form-control" name="phone" placeholder="961518977">
